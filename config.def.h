 ...
 */
static char *font = "firecode:pixelsize=17:antialias=true:autohint=true";
...
static char *openurlcmd[] = { "/bin/sh", "-c",
    "sed 's/.*│//g' | tr -d '\n' | grep -aEo '(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./&%?=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)'| uniq | sed 's/^www./http:\\/\\/www\\./g' | /bin/dmen -p Urls -l 10 | xargs -r xdg-open",
    "externalpipe", NULL };
